...
**WorkoutLog Manager** est une application de bureau JavaFX destinée aux administrateurs, permettant la gestion et la manipulation des données liées à WorkoutLog web app : https://workoutlog-c5r8.onrender.com.  
